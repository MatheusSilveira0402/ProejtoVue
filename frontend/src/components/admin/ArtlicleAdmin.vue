         ...
         <b-form>   
            <input type="hidden" id="article-id" v-model="article.id" /> 
                ...
                <b-form-group v-if="mode === 'save'"  label="Imagem (URL):" label-for="article-imageUrl">
                    <b-form-input b-form-input id="article-imageUrl" type="text" 
                ...
                <b-form-group 
                    label="Autor:" v-if="mode === 'save'"  label-for="article-userId">
                    <b-form-select v-if="mode === 'save'"
                        id="article-categoryId" 
                        :options="users" 
                        v-model="article.userId" />
                </b-form-group>
                 <b-form-group v-if="mode === 'save'" label="Conteúdo" label-for="article-parentId">
